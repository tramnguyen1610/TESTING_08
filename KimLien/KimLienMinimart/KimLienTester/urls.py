...
urlpatterns = [
    ...
    path('api/nhaphang/get-next-ma-phieu/', views.get_next_ma_phieu, name='get_next_ma_phieu'),
    ...
    # API Sản phẩm (ĐÃ XÓA ĐƯỜNG DẪN DELETE)
    ...
    path('api/lohang/get-next-ma-lo/', views.get_next_ma_lo, name='get_next_ma_lo'),
